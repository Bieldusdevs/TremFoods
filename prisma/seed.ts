...
const products: ProductSeed[] = [
  // ── 1. Trem Tropical
  {
    ...
    priceCents: 950,
    image: '/img/items/trem-tropical.jpg',
    isFeatured: true,
    isNew: true,
  ...
  // ── 2. Trem Picanha
  {
    ...
    category: 'hamburgueres',
    priceCents: 1290,
    image: '/img/items/trem-picanha.jpg',
    isFeatured: true,
  ...
  // ── 3. Trem Bagunça
  {
    ...
    category: 'hamburgueres',
    priceCents: 1350,
    image: '/img/items/trem-bagunca.jpg',
    isFeatured: true,
  ...
  // ── 4. Trem Costela
  {
    ...
    category: 'hamburgueres',
    priceCents: 1390,
    image: '/img/items/trem-costela.jpg',
    isFeatured: true,
  ...
  // ── 5. Trem Bacon
  {
    ...
    category: 'hamburgueres',
    priceCents: 900,
    image: '/img/items/trem-bacon.jpg',
  ...
  // ── 6. Trem Laçador Burger
  {
    ...
    category: 'hamburgueres',
    priceCents: 800,
    image: '/img/items/trem-lacador.jpg',
  ...
  // ── 7. Trem Banana Burger
  {
    ...
    category: 'hamburgueres',
    priceCents: 950,
    image: '/img/items/trem-banana.jpg',
  ...
  // ── 8. Combo Menu Trem Tudo Especial
  {
    ...
    category: 'combos',
    priceCents: 1090,
    image: '/img/items/combo-trem-tudo.jpg',
    isFeatured: true,
    isNew: true,
  ...
  // ── 9. Tábua Trem Food
  {
    ...
    category: 'petiscos',
    priceCents: 4450,
    image: '/img/items/tabua-trem-food.jpg',
    isFeatured: true,
  ...
  // ── 10. Fritas com Bacon e Cheddar
  {
    ...
    category: 'petiscos',
    priceCents: 890,
    image: '/img/items/fritas-bacon-cheddar.jpg',
  ...
  // ── 11. Coração com Fritas
  {
    ...
    category: 'petiscos',
    priceCents: 990,
    image: '/img/items/coracao-fritas.jpg',
  ...
  // ── 12. Trio Trem Food
  {
    ...
    category: 'petiscos',
    priceCents: 2490,
    image: '/img/items/trio-trem-food.jpg',
  ...
  // ── 13. Torre de Batata
  {
    ...
    category: 'petiscos',
    priceCents: 1790,
    image: '/img/items/torre-de-batata.jpg',
    isFeatured: true,
  ...
  // ── 14. Picanha com Mandioca e Queijo
  {
    ...
    category: 'petiscos',
    priceCents: 1390,
    image: '/img/items/picanha-mandioca-queijo.jpg',
  ...
  // ── 15. Filé de Tilápia com Fritas
  {
    ...
    category: 'petiscos',
    priceCents: 1290,
    image: '/img/items/file-tilapia-fritas.jpg',
  ...
  // ── 16. Esparguete
  {
    ...
    category: 'pratos',
    priceCents: 950,
    image: '/img/items/esparguete-da-casa.jpg',
  ...
  // ── 17. Espetinhos
  {
    ...
    category: 'petiscos',
    priceCents: 490,
    image: '/img/items/espetinhos-grelhados.jpg',
  ...
  // ── 18. Prato de Picanha com Ovo
  {
    ...
    category: 'pratos',
    priceCents: 1190,
    image: '/img/items/prato-picanha-ovo.jpg',
    isFeatured: true,
  ...
  // ── 19. Prato de Frango com Ovo
  {
    ...
    category: 'pratos',
    priceCents: 990,
    image: '/img/items/prato-frango-ovo.jpg',
  ...
  // ── 20. Caldos
  {
    ...
    priceCents: 790,
    image: '/img/items/caldos-tradicionais.jpg',
  ...
  // ── 21. Pães de Alho
  {
    ...
    category: 'caldos-salgados',
    priceCents: 490,
    image: '/img/items/paes-de-alho.jpg',
  ...
  // ── 22. Açaí
  {
    ...
    category: 'sobremesas',
    priceCents: 990,
    image: '/img/items/acai-especial.jpg',
    isFeatured: true,
  ...
  // ── 23. Pudim Brasileiro
  {
    ...
    category: 'sobremesas',
    priceCents: 300,
    image: '/img/items/pudim-brasileiro.jpg',
  ...
  // ── 24. Salgados
  {
    ...
    category: 'caldos-salgados',
    priceCents: 300,
    image: '/img/items/salgados-artesanais.jpg',
  ...
  // ── 25. Hot Dogs
  {
    ...
    category: 'hot-dogs',
    priceCents: 600,
    image: '/img/items/hot-dogs-artesanais.jpg',
    isFeatured: true,
